...
namespace newform
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            soundPlayer = new SoundPlayer(Properties.Resources.Tiengech1); // Phát nhạc từ Resources
        ...
        private void KhoiTaoGame()
        {
            ...
            carTimer.Interval = 25; // Điều chỉnh tốc độ xe (càng lớn càng chậm)
        ...
        {
            int step = 10; // Điều chỉnh bước di chuyển của ếch
        ...
        private void CarTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (ech.Top <= 0)
            {
                ...
                this.Hide(); // Ẩn Form2
                Form3 form3 = new Form3(); // Tạo một instance của Form3
                form3.ShowDialog(); // Hiển thị Form3
                return; // Dừng xử lý thêm
            }
        }
